...
\setbeamertemplate{footline}{\hspace{5mm} \inserttitle~| \insertdate~| \insertshortauthor \hfill
...
\subtitle{Vorlage für die Präsentation von Werkstück A -- SS2018}
\author[Henry-Norbert Cocos] % (optional, for multiple authors)
{Henry-Norbert Cocos\inst{}\\Matrikelnummer: 12345\\\nolinkurl{cocos@stud.fra-uas.de}}


\institute[Frankfurt] % (optional)
{	
	Informatik\\
	Fachbereich 2 - Informatik und Ingenieurwissenschaft\\
	\textbf{Frankfurt University of Applied Sciences}	
}

 % (optional)
\date[\today]{\today}
\subject{Vorlage für die Präsentation von Werkstück A}
%\logo{\includegraphics[height=1cm]{./Figures/frauas}} % Das ist vorsichtshalber aus Copyright Gründen auskommentiert

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\hypersetup{
	pdftitle    = {Betriebssysteme und Rechnernetze -- Vorlage für die Abgabe von Werkstück A-- SS2018},
	pdfsubject  = {Betriebssysteme und Rechnernetze},
	pdfauthor   = {Henry-Norbert Cocos},
