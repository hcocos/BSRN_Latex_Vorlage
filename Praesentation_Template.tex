...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VARIABLEN FUER TITEL, AUTOR, ETC.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\newcommand{\myEmail}{cocos@fb2.fra-uas.de}
\newcommand{\myTitle}{\LaTeX Beamer Vorlage}
\newcommand{\mySubtitle}{Zur Nutzung im Kurs Betriebssysteme und Rechnernetze}
...
% Für Sprache im Quellen und Referenzen \usepackage[english]{babel} angeben!
